...
/**
 * Batch-generate Hindi content for multiple trends in ONE API call.
 ...
 */
export async function generateHindiContentBatch(items) {
  if (!GROQ_API_KEY || items.length === 0) {
    return items.map(() => null);
  }

  // Build the prompt with all items numbered
